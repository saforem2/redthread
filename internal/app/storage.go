...
// SaveWorkspace writes the workspace as a v6 file (workspace envelope),
...
func rotateBackup(path string, next []byte) {
	...
	// Name by content-modification time so the ring sorts chronologically
	// and a same-second save does not collide.
